...
public class NaiveBayes extends AbstractClassifierModel {
	...
	public Classifier getClassifier() throws Exception {
		...
		weka.classifiers.bayes.NaiveBayes naiveBayes = new weka.classifiers.bayes.NaiveBayes();
	...
	public String getOutputHeader() {
		return "Naive Bayes with parameters: " + StringUtils.join(getParams());
	}
